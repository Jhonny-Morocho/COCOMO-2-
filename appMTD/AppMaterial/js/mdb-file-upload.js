...
(function(e, i) {
    ...
    var t = "file_upload";
    return i.prototype.onChange = function(e) {
        this.resetPreview(),
        this.element.files.length ? this.readFile(this.element, true) : this.readFile(this.element, false)
    }
    ,
    ...
    i.prototype.readFile = function(i, dir) {
        if (i.files && i.files[0]) {
            ...
            this.showLoader(),
            dir ? (h = {},
            h.name = r.webkitRelativePath.split(/\u002f/)[0],
            h.type = null,
            h.size = null,
            this.setFileInformations(h)
            ) : this.setFileInformations(r),
            this.errorsEvent.errors = [],
            this.checkFileSize(),
            this.isFileExtensionAllowed(),
            this.isImage() && this.file.size < this.sizeToByte(this.settings.maxFileSizePreview) ? (this.input.on("file_upload.fileReady", this.onFileReady),
            t.readAsDataURL(r),
            t.onload = function(e) {
                n = e.target.result,
    ...
    i.prototype.onFileReady = function(e, i, t) {
        if (this.input.off("file_upload.fileReady", this.onFileReady),
    ...
    i.prototype.setPreview = function(i, t) {
        ...
        i === !0) {
            ...
            this.input[0].webkitdirectory ? e("<i />").attr("class", "fas fa-folder").appendTo(s) : e("<i />").attr("class", "fas fa-file").appendTo(s),
            e('<span class="file-upload-extension" />').html(this.getFileType()).appendTo(s);
        this.preview.fadeIn()
    }
    ,
    ...
    i.prototype.isFileExtensionAllowed = function() {
        return "-1" != this.settings.allowedFileExtensions.indexOf("*") || "-1" != this.settings.allowedFileExtensions.indexOf(this.getFileType()) || (this.pushError("fileExtension"),
        !1)
    }
    ,
